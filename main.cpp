...
void drawScene() {
    ...
    glVertex3f(1.5f, 1.0f, 0.0f);// x1,y1,z1
	glVertex3f(1.5f, 2.0f, 0.0f);// x2,y2,z2
	glVertex3f(1.5f, 1.0f, 1.50f); // x3,y3,z3
	glVertex3f(1.5f, 1.0f, -1.5f);// x4, y4, z4
	...
	glVertex3f(1.8f, 2.0f, 0.0f);
	glVertex3f(1.8f, 0.860f, -1.75f);
	glVertex3f(-1.8f, 0.860f, -1.75f);

	glVertex3f(-1.8f, 0.86f, 1.75f);
	glVertex3f(1.8f, 0.860f, 1.75f);
	glVertex3f(1.8f, 2.0f, -0.0f);
	glVertex3f(-1.8f, 2.0f, -0.0f);
	// top ends here
